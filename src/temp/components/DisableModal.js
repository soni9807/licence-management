...
import Heading from "../../components/Atoms/typography/Heading.jsx";
  ...
  return (
    <div className="w-full px-20 py-10">
      <div className="bg-[#1F3651] fixed top-0 left-0 w-full z-10">
        <Heading heading="Disable license" color="white" variant="large" />
      </div>
      <div className="pt-16">
        <CAlert
                          ...
                          <div>
                            <div className="container-fluid">
                              ...
                              <table className="custom_confirm-table">
                                <thead>
                                  <tr>
                                    <th className="custom_confirm-th">
                                      Cluster
                                    </th>
                                    <th className="custom_confirm-th">
                                      Tenant Id
                              ...
                              <div className="flex justify-start item-center space-x-2 py-6">
                                <PrimaryButton
                                  buttonText={"Submit"}
