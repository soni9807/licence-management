...
import '../../temp/components/GenerateModal.css'
import { plan_config, config_gb_per_day } from "../../util/plans/plan_config.js"
import Heading from '../Atoms/typography/Heading.jsx'
import LincenseTable from '../Organisms/GenrateLicense/LincenseTable.jsx'
import { CAlert } from '@coreui/react'
import { disable_plan_config } from '../../util/plans/plan_config.js';
import PrimaryButton from '../Atoms/Buttons/PrimaryButton.jsx'



const GenerateLincence = ({
    isOpen,
    onClose,
    ...
    const [heading, setHeading] = useState('Generate License')
    ...
    return (
        <div className="w-full">
            <div className='bg-[#1F3651] fixed top-0 left-0 w-full z-10'>
                <Heading heading={heading} color='white'  variant='large' />
            </div>
            <div className='pt-20 px-20'>
                ...
                {title !== 'renew_license' && <Heading heading="Note: Please generate license specifically for new tenants." variant='small' customStyles="font-semibold pb-4" color='red' />}
                <div className=" pb-20">
                    ...
                    <LincenseTable plan={plan} data={data} isSubmitted={isSubmitted} featureValuesDict={featureValuesDict} />

                    <table key={plan} className="custom-table mt-10" readOnly={isSubmitted}>
                        <thead>
                            <tr>
            ...
            <div className='mb-3 fixed bottom-0 left-0 w-full z-10'>
                <PrimaryButton customStyles="mt-5 ml-auto mr-5 px-10" disabled={isSubmitted} onPress={handleConfirmSubmit} loading={loading} buttonText={loading ? "Submitting..." : "Submit"} />
            </div>
        </div >
    )
}

export default GenerateLincence

GenerateLincence.defaultProps = {
    title: '',
    body: '',
}

GenerateLincence.propTypes = {
